...
makedepends="$_depends_dev sed installkernel bc linux-headers linux-firmware-any openssl-dev
	diffutils findutils"
options="!strip"
_config=${config:-config-zeron.${CARCH}}
install=
...
prepare() {
	...
	# Create build time autogenerated kernel key
...
build() {
	...
	for i in $_flavors; do
		...
		make ARCH="$_carch" CC="${CC:-gcc}" \
			KBUILD_BUILD_VERSION="$((pkgrel + 1 ))-Alpine" -j8
	done
}
...
_dev() {
	...
	mkdir -p "$dir/certs"
	cp "$srcdir/signing_certs.pem" "$dir/certs/signing_certs.pem"
...
7220d3196e16002ee76de90b624dde36bc8f1416398ef831e4e82b7a67337ff5c6ef7670bfdf1a5e8b8f0ca0bed644b332f54fc460751c70eaa9907ee03bcb2a  config-zeron.aarch64
d1d1aa52cba16040bf8f6230ea9d603e1e249977d5830fa7b88d93f0456f56b6f54aa68f192cb29f1ab44e2b8e8eac4ac72c220a53ef0719a5f66425fcb46001  config-zeron.x86
8b37ae71b4b5192c900f277e5b4b0989c2ddb98bc2796588e6122e46c373ea85a4e5ebe500bb773b95260d4298c81e784d545d05d2808c229577ef7f32ce6be7  config-zeron.x86_64
94c404004734884ed880250f074778e75483815529cc19f12030bed54012b0ca081fe6e6618f7643b9d673d9b7bd649a597ec52f71f9c7f336a682e00d52b2e8  patch-5.10.29.xz
4c5713459bb32ee368a975811da178024ec53e14450d5489c34cf9234736346eb42f836c693df1b21af7667b758004d63d764dba015058ce8fc3e44d776c7153  zeron-uefi-certs.pem"
